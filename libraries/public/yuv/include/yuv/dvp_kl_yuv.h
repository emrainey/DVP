...
enum {
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [input]  Image color type supported: FOURCC_IYUV
     * \param [output] Image color type supported: FOURCC_BGR
     */
     ...
     * \param [input]  Image color type supported: FOURCC_UYVY
     * \param [out1] Image color type supported: FOURCC_RGBP
     * \param [out2] Image color type supported: FOURCC_Y800
     * \param [out3] Image color type supported: FOURCC_YV24 or FOURCC_YU24
     */
