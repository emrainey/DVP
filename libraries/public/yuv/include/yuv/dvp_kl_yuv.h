...
enum {
     ...
     * \param [in]  Image color type supported: FOURCC_UYVY
     * \param [out] Image color type supported: FOURCC_IYUV or FOURCC_YV12
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_UYVY
     * \param [out] Image color type supported: FOURCC_RGBP
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_UYVY or FOURCC_VYUY
     * \param [out] Image color type supported: FOURCC_Y800
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_YVYU or FOURCC_YUY2
     * \param [out] Image color type supported: FOURCC_Y800
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_Y800
     * \param [out] Image color type supported: FOURCC_UYVY
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_UYVY
     * \param [out] Image color type supported: FOURCC_BGR
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_UYVY
     * \param [out] Image color type supported: FOURCC_RGB565
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_IYUV
     * \param [out] Image color type supported: FOURCC_BGR
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_RGB888 or FOURCC_BGR
     * \param [out] Image color type supported: FOURCC_UYVY
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_RGB888 or FOURCC_BGR
     * \param [out] Image color type supported: FOURCC_IYUV
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_UYVY
     * \param [out] Image color type supported: FOURCC_YV24 or FOURCC_YU24
     */
    DVP_KN_YUV_UYVY_TO_YU24,

    /*!
     * Converts FOURCC_UYVY format to FOURCC_NV12 or FOURCC_YV24 format. Luma plane is halved in each direction.\n
     * Configuration Structure: DVP_Transform_t
     * \param [in]  Image color type supported: FOURCC_NV12
     * \param [out] Image color type supported: FOURCC_YV24 or FOURCC_YU24
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in] Image color type supported: FOURCC_ARGB
     * \param [out] Image color type supported: FOURCC_UYVY
     */
     ...
     * Configuration Structure: DVP_Transform_t
     * \param [in] Image color type supported: FOURCC_YU24 or FOURCC_YV24
     * \param [in] Image color type supported: FOURCC_RGBP
     */
