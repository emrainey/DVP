...
enum {
     ...
     * \param [input]    Image color type supported: FOURCC_Y800
     * \param [output]   Image color type supported: FOURCC_Y800
     * \param [tempBuf1] Image color type supported: FOURCC_Y16
     * \param [tempBuf2] Image color type supported: FOURCC_Y16
     * \param [tempBuf3] Image color type supported: FOURCC_Y16
     * \param [tempBuf4] Image color type supported: FOURCC_Y16
     */
     ...
     * \param [input]       Image color type supported: FOURCC_Y800
     * \param [harrisScore] Image color type supported: FOURCC_Y16
     */
     ...
     * \param [input]          Image color type supported: FOURCC_Y16
     * \param [blockMaximaMAX] Image color type supported: FOURCC_Y16
     * \param [blockMaximaX]   Image color type supported: FOURCC_Y16
     * \param [blockMaximaY]   Image color type supported: FOURCC_Y16
     */
     ...
     * \param [nmsStep1X]   Image color type supported: FOURCC_Y16
     * \param [nmsStep1Y]   Image color type supported: FOURCC_Y16
     * \param [nmsStep1Dst] Image color type supported: FOURCC_Y800
     */
     ...
     * \param [output] Image color type supported: FOURCC_YU24 or FOURCC_YV24
     */
